...
public class StudentManagementDao {
	...
	private static StudentManagementDao instance = null;

	public static StudentManagementDao Instance() {
		if (instance == null) {
			synchronized (StudentManagementDao.class) {
				if (instance == null) {
					instance = new StudentManagementDao();
				}
			}
		}
		return instance;

...
public class DictonaryDao {
	private static DictonaryDao instance = null;
	Library library = new Library();

	Validation validation = new Validation();

	public static DictonaryDao Instance() {
		if (instance == null) {
			synchronized (DictonaryDao.class) {
				if (instance == null) {
					instance = new DictonaryDao();
				}
			}
		}
		return instance;
